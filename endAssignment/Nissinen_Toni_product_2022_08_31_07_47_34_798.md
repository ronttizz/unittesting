...
>Returns:
>>Returns true if the product matching the searchKey has `info` array and it is not an empty array else returns false. If parameter searchKey is missing false is returned
